...
public class BewerkPersoneel extends javax.swing.JFrame {
     ...
     */
    public BewerkPersoneel(PersoneelBeheer overzicht, int id) {
        this.id = id;
        this.overzicht = overzicht;
        
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Personeel bewerken");
    ...
    private void getGebruiker() {
        ...
        tf_voornaam.setText(gebruiker.getVoornaam());
        tf_achternaam.setText(gebruiker.getAchternaam());
        tf_email.setText(gebruiker.getEmail());
        tf_gebruikersnaam.setText(gebruiker.getGebruikersnaam());
        pf_wachtwoord.setText(gebruiker.getWachtwoord());
        cb_accounttype.setSelectedItem(gebruiker.getAccounttype());
    }
    ...
    private void btn_bewerkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_bewerkActionPerformed
        ...
        WinkelApplication.getQueryManager().updateGebruiker(gebruiker, id);
        clearTextfields();
